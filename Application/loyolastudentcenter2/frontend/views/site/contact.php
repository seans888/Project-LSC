 ...
 <div class="container set-pad">
      <div class="row text-center">
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                     ...
                     <p data-scroll-reveal="enter from the bottom after 0.3s">If you have business inquiries or other questions, please fill out the following form to contact us.
                         </p>
                 </div>
           ...
           <div class="row set-row-pad"  data-scroll-reveal="enter from the bottom after 0.5s" >
            ...
            <?php $form = ActiveForm::begin(['id' => 'contact-form']); ?>
                ...
                <?= $form->field($model, 'name')->textInput(['autofocus' => false,'placeholder'=>'Your name'])->label(false) ?>
                ...
                <div class="form-group">
                    <?= Html::submitButton('Submit', ['class' => 'btn btn-info btn-block btn-lg', 'name' => 'contact-button']) ?>
                </div>
